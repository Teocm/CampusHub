...
namespace CampusHub.API.Migrations
{
    ...
    [Migration("20230516063954_EntitiesProyect")]
    partial class EntitiesProyect
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CampusHub.Shared.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CampusHub.Shared.Entities.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CampusHub.Shared.Entities.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UniversityLife", b =>
                {
                    ...
                    b.ToTable("UniversityLives");
                });

            modelBuilder.Entity("CampusHub.Shared.Entities.City", b =>
                {
                    b.HasOne("CampusHub.Shared.Entities.State", "State")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("CampusHub.Shared.Entities.State", b =>
                {
                    b.HasOne("CampusHub.Shared.Entities.Country", "Country")
                        .WithMany("States")
            ...
            modelBuilder.Entity("CampusHub.Shared.Entities.User", b =>
                {
                    b.HasOne("CampusHub.Shared.Entities.City", "City")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CampusHub.Shared.Entities.User", null)
                        .WithMany()
